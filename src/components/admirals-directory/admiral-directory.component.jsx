...
import Admiral from '../admiral/admiral.component';
import './admiral-directory.styles.css'

class Admiraldirectory extends React.Component {
    constructor() {
        super();
        this.state = {
          sections: [{
...
export default Admiraldirectory