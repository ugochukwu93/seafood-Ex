...
import Sharon from '../sharon/sharon.component';
import './sharon-directory.styles.css'

class Sharondirectory extends React.Component {
    constructor() {
        super();
        this.state = {
          sections: [{
...
export default Sharondirectory